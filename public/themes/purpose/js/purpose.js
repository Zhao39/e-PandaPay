"use strict";
var Layout = function() {
        function e(e) { $(".sidenav-toggler").addClass("active"), $(".sidenav-toggler").data("action", "sidenav-unpin"), $("body").addClass("sidenav-pinned ready"), $("body").find(".main-content").append('<div class="sidenav-mask mask-body d-xl-none" data-action="sidenav-unpin" data-target=' + e.data("target") + " />"), $(e.data("target")).addClass("show"), localStorage.setItem("sidenav-state", "pinned") }

        function t(e) { $(".sidenav-toggler").removeClass("active"), $(".sidenav-toggler").data("action", "sidenav-pin"), $("body").removeClass("sidenav-pinned"), $("body").addClass("ready"), $("body").find(".sidenav-mask").remove(), $(e.data("target")).removeClass("show"), localStorage.setItem("sidenav-state", "unpinned") }
        var a = localStorage.getItem("sidenav-state") ? localStorage.getItem("sidenav-state") : "pinned";
        if ($(window).on({ "load resize": function() { $(window).width() < 1200 ? t($(".sidenav-toggler")) : "pinned" == a ? e($(".sidenav-toggler")) : "unpinned" == a && t($(".sidenav-toggler")) } }), $("body").on("click", "[data-action]", function(a) {
                a.preventDefault();
                var n = $(this),
                    o = n.data("action"),
                    i = n.data("target");
    ...
    CardActions = function() {
        ...
        e.length && $(t).length && (e.on({
            mouseenter: function() {
                var e, a, n;
                e = $(this), a = e.find(t), n = a.data("animation-in"), a.length && (a.addClass("in animated " + n), a.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() { a.removeClass("animated " + n) }))
            }
        }), e.on({
            mouseleave: function() {
                var e, a, n;
                e = $(this), a = e.find(t), n = a.data("animation-out"), a.length && (a.addClass("animated " + n), a.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() { a.removeClass("in animated " + n) }))
            }
        }))
    }(),
    Dropdown = function() {
        ...
        e.length && e.on({ "hide.bs.dropdown": function() {} }), t.length && t.on("click", function(e) {
            return function(e) {
                e.next().hasClass("show") || e.parents(".dropdown-menu").first().find(".show").removeClass("show");
                var t = e.next(".dropdown-menu");
                t.toggleClass("show"), t.parent().toggleClass("show"), e.parents(".nav-item.dropdown.show").on("hidden.bs.dropdown", function(e) { $(".dropdown-submenu .show").removeClass("show") })
            }($(this)), !1
        })
    }(),
    ...
    CustomInputFile = function() {
        ...
        e.length && e.each(function() {
            ...
            }), e.on("focus", function() {! function(e) { e.addClass("has-focus") }(e) }).on("blur", function() {! function(e) { e.removeClass("has-focus") }(e) })
        })
    }(),
    NavbarVertical = function() {
        ...
        t.on({
            ...
            "hide.bs.dropdown": function() {
                var e, t;
                e = $(this), (t = e.find(".dropdown-menu")).addClass("close"), setTimeout(function() { t.removeClass("close") }, 200)
            }
        })
    }(),
    ...
    ScrollTo = function() {
        ...
        e.length && e.on("click", function(e) { a($(this)) }), $(window).on("load", function() {
            var e;
            ...
            return function(e, a) {
                ...
                if (a.isDefaultPrevented());
                    ...
                    e.find('button[type="submit"]').text("Sending..."), i.done(function(a, o) {
                        var i = a.status;
                        t(a.notify_title, a.notify_message, a.notify_type), "success" == i && (e.find(".btn-reset").trigger("click"), grecaptcha.reset()), e.find('button[type="submit"]').text("Message sent!"), setTimeout(function() { e.find('button[type="submit"]').text(n) }, 3e3)
                    }), i.fail(function(a, o) { a.status, t(a.notify_title, a.responseText, "danger"), e.find('button[type="submit"]').text("Error!"), setTimeout(function() { e.find('button[type="submit"]').text(n) }, 3e3) })
                }
            }($(this), e), !1
        })
    }(),
                        ...
                        e.imagesLoaded().done(function(t) {
                            e.find(".animated").each(function() {
                                ...
                                if (!e.hasClass("animation-ended")) {
                                    ...
                                    setTimeout(function() { e.addClass("animation-ended " + t, 100).on("webkitAnimationEnd animationend", function() { e.removeClass(t) }) }, a)
                                }
                            })
                        })
                    }($(this))
    ...
    GoogleMapCustom = function() {
        ...
        void 0 !== n && null != n && google.maps.event.addDomListener(window, "load", function(n) {
            ...
            var o = new google.maps.LatLng(e, t),
                i = { zoom: 12, scrollwheel: !1, center: o, mapTypeId: google.maps.MapTypeId.ROADMAP, styles: [{ featureType: "administrative", elementType: "labels.text.fill", stylers: [{ color: "#444444" }] }, { featureType: "landscape", elementType: "all", stylers: [{ color: "#f2f2f2" }] }, { featureType: "poi", elementType: "all", stylers: [{ visibility: "off" }] }, { featureType: "road", elementType: "all", stylers: [{ saturation: -100 }, { lightness: 45 }] }, { featureType: "road.highway", elementType: "all", stylers: [{ visibility: "simplified" }] }, { featureType: "road.arterial", elementType: "labels.icon", stylers: [{ visibility: "off" }] }, { featureType: "transit", elementType: "all", stylers: [{ visibility: "off" }] }, { featureType: "water", elementType: "all", stylers: [{ color: a }, { visibility: "on" }] }] };
            ...
            google.maps.event.addListener(s, "click", function() { r.open(n, s) })
        }(n))
    }(),
    GoogleMap = function() {
        ...
        void 0 !== a && null != a && google.maps.event.addDomListener(window, "load", function(a) {
            ...
            google.maps.event.addListener(i, "click", function() { s.open(a, i) })
        }(a))
    }(),
...
! function(e) {
    e.fn.countTo = function(t) {
        return t = t || {}, e(this).each(function() {
            ...
            s.data("countTo", d), d.interval && clearInterval(d.interval), d.interval = setInterval(function() { r++, c(l += o), "function" == typeof a.onUpdate && a.onUpdate.call(i, l), r >= n && (s.removeData("countTo"), clearInterval(d.interval), l = a.to, "function" == typeof a.onComplete && a.onComplete.call(i, l)) }, a.refreshInterval), c(l)
        })
...
var Counter = function() {
    ...
    Datepicker = function() {
        var e = $('[data-toggle="date"]'),
            ...
            a = $('[data-toggle="time"]');
        e.length && e.each(function() { $(this).flatpickr({ enableTime: !1, allowInput: !0 }) }), t.length && t.each(function() { $(this).flatpickr({ enableTime: !0, allowInput: !0 }) }), a.length && a.each(function() { $(this).flatpickr({ noCalendar: !0, enableTime: !0, allowInput: !0 }) })
    }();
! function(e) {
    ...
    t.prototype.init = function() {
        e('[data-toggle="dragula"]').each(function() {
            ...
            o ? dragula(a, { moves: function(e, t, a) { return a.classList.contains(o) } }) : dragula(a)
        })
...
var Dropzones = function() {
        ...
        e.length && (Dropzone.autoDiscover = !1, e.each(function() {
            var e, a, n, o, i;
            e = $(this), a = void 0 !== e.data("dropzone-multiple"), n = e.find(t), o = void 0, i = { url: e.data("dropzone-url"), thumbnailWidth: null, thumbnailHeight: null, previewsContainer: n.get(0), previewTemplate: n.html(), maxFiles: a ? null : 1, acceptedFiles: a ? null : "image/*", init: function() { this.on("addedfile", function(e) {!a && o && this.removeFile(o), o = e }) } }, n.html(""), e.dropzone(i)
        }))
    }(),
    Fullcalendar = function() {
        ...
        a.length && (t = {
            ...
            viewRender: function(t) { e.fullCalendar("getDate").month(), $(".fullcalendar-title").html(t.title) },
            eventClick: function(e, t) { $("#edit-event input[value=" + e.className + "]").prop("checked", !0), $("#edit-event").modal("show"), $(".edit-event--id").val(e.id), $(".edit-event--title").val(e.title), $(".edit-event--description").val(e.description) }
    ...
    Masonry = function() {
        ...
        e.length && e.each(function() {
            ...
            e = $(this), t = e.find(".masonry"), a = e.find(".masonry-filter-menu"), n = a.find(".active"), o = n.data("filter"), i = t.imagesLoaded(function() {
                ...
                n = "*" == n ? "" : "." + n, i.isotope({ filter: n }).on("arrangeComplete", function() { a.find("[data-filter]").removeClass("active"), t.addClass("active") })
            })
        })
    }(),
    Notify = function() {
    ...
    Typed = function() {
        ...
        e.length && e.each(function() {
            var e, t, a, n;
            e = $(this), t = "#" + e.attr("id"), a = (a = e.data("type-this")).split(","), n = new Typed(t, { strings: a, typeSpeed: 100, backSpeed: 70, loop: !0 }), inView(t).on("enter", function() { n.start() }).on("exit", function() { n.stop() })
        })
    }(),
    Wavify = function() {
        var e = $('[data-toggle="wavify"]');
        e.length && e.each(function() { $(this).find("path").wavify({ height: 50, bones: 5, amplitude: 40, speed: .15 }) })
    }(),
    EngagementChart = function() {
        var e = $("#apex-engagement");
        e.length && e.each(function() {
            ! function(e) {
                var t = { chart: { width: "100%", zoom: { enabled: !1 }, toolbar: { show: !1 }, shadow: { enabled: !1 } }, stroke: { width: 7, curve: "smooth" }, series: [{ name: "Likes", data: [4, 3, 10, 9, 29, 19, 22, 9] }], xaxis: { labels: { format: "MMM", style: { colors: PurposeStyle.colors.gray[600], fontSize: "14px", fontFamily: PurposeStyle.fonts.base, cssClass: "apexcharts-xaxis-label" } }, axisBorder: { show: !1 }, axisTicks: { show: !0, borderType: "solid", color: PurposeStyle.colors.gray[300], height: 6, offsetX: 0, offsetY: 0 }, type: "datetime", categories: ["1/11/2000", "2/11/2000", "3/11/2000", "4/11/2000", "5/11/2000", "6/11/2000", "7/11/2000", "8/11/2000"] }, yaxis: { labels: { style: { color: PurposeStyle.colors.gray[600], fontSize: "12px", fontFamily: PurposeStyle.fonts.base } }, axisBorder: { show: !1 }, axisTicks: { show: !0, borderType: "solid", color: PurposeStyle.colors.gray[300], height: 6, offsetX: 0, offsetY: 0 } }, fill: { type: "solid" }, markers: { size: 4, opacity: .7, strokeColor: "#fff", strokeWidth: 3, hover: { size: 7 } }, grid: { borderColor: PurposeStyle.colors.gray[300], strokeDashArray: 5 }, dataLabels: { enabled: !1 } },
                ...
                setTimeout(function() { i.render() }, 300)
            }($(this))
        })
    }(),
    LineChart = function() {
        ...
        e.length && e.each(function() {
            ! function(e) {
                var t = { chart: { zoom: { enabled: !1 }, toolbar: { show: !1 }, shadow: { enabled: !1 } }, stroke: { width: 7, curve: "smooth" }, series: [{ name: "Likes", data: [4, 3, 10, 9, 29, 19, 22, 9, 12, 7, 19, 5, 13, 9] }], xaxis: { labels: { format: "MMM", style: { colors: PurposeStyle.colors.gray[600], fontSize: "14px", fontFamily: PurposeStyle.fonts.base, cssClass: "apexcharts-xaxis-label" } }, axisBorder: { show: !1 }, axisTicks: { show: !0, borderType: "solid", color: PurposeStyle.colors.gray[300], height: 6, offsetX: 0, offsetY: 0 }, type: "datetime", categories: ["1/11/2000", "2/11/2000", "3/11/2000", "4/11/2000", "5/11/2000", "6/11/2000", "7/11/2000", "8/11/2000", "9/11/2000", "10/11/2000", "11/11/2000", "12/11/2000", "1/11/2001", "2/11/2001"] }, yaxis: { labels: { style: { color: PurposeStyle.colors.gray[600], fontSize: "12px", fontFamily: PurposeStyle.fonts.base } }, axisBorder: { show: !1 }, axisTicks: { show: !0, borderType: "solid", color: PurposeStyle.colors.gray[300], height: 6, offsetX: 0, offsetY: 0 } }, fill: { type: "solid" }, markers: { size: 4, opacity: .7, strokeColor: "#fff", strokeWidth: 3, hover: { size: 7 } }, grid: { borderColor: PurposeStyle.colors.gray[300], strokeDashArray: 5 }, dataLabels: { enabled: !1 } },
                    a = (e.data().dataset, e.data().labels, e.data().color),
                    n = e.data().height,
                    o = e.data().type;
                t.colors = [PurposeStyle.colors.theme[a]], t.markers.colors = [PurposeStyle.colors.theme[a]], t.chart.height = n || 350, t.chart.type = o || "line";
    ...
    SparkChart = function() {
        ...
        e.length && e.each(function() {
            ! function(e) {
                var t = { chart: { width: "100%", sparkline: { enabled: !0 } }, series: [], labels: [], stroke: { width: 2, curve: "smooth" }, markers: { size: 0 }, colors: [], tooltip: { fixed: { enabled: !1 }, x: { show: !1 }, y: { title: { formatter: function(e) { return "" } } }, marker: { show: !1 } } },
                    a = e.data().dataset,
                    n = e.data().labels,
                    o = e.data().color,
                    i = e.data().height,
                ...
                setTimeout(function() { r.render() }, 300)
            }($(this))
        })
    }(),
    WorkedHoursChart = function() {
        ...
        e.length && e.each(function() {
            ! function(e) {
                var t = { chart: { width: "100%", type: "bar", zoom: { enabled: !1 }, toolbar: { show: !1 }, shadow: { enabled: !1 } }, plotOptions: { bar: { horizontal: !1, columnWidth: "30%", endingShape: "rounded" } }, stroke: { show: !0, width: 2, colors: ["transparent"] }, series: [{ name: "Worked hours", data: [40, 30, 100, 90, 20] }], xaxis: { labels: { format: "MMM", style: { colors: PurposeStyle.colors.gray[600], fontSize: "14px", fontFamily: PurposeStyle.fonts.base, cssClass: "apexcharts-xaxis-label" } }, axisBorder: { show: !1 }, axisTicks: { show: !0, borderType: "solid", color: PurposeStyle.colors.gray[300], height: 6, offsetX: 0, offsetY: 0 }, type: "datetime", categories: ["1/11/2000", "2/11/2000", "3/11/2000", "4/11/2000", "5/11/2000"] }, yaxis: { labels: { style: { color: PurposeStyle.colors.gray[600], fontSize: "12px", fontFamily: PurposeStyle.fonts.base } }, axisBorder: { show: !1 }, axisTicks: { show: !0, borderType: "solid", color: PurposeStyle.colors.gray[300], height: 6, offsetX: 0, offsetY: 0 } }, fill: { type: "solid" }, markers: { size: 4, opacity: .7, strokeColor: "#fff", strokeWidth: 3, hover: { size: 7 } }, grid: { borderColor: PurposeStyle.colors.gray[300], strokeDashArray: 5 }, dataLabels: { enabled: !1 } },
                    a = (e.data().dataset, e.data().labels, e.data().color),
                    n = e.data().height;
                ...
                setTimeout(function() { o.render() }, 300)
            }($(this))
        })
    }();