...
(31, '0EXbji', 'Phone Number', '+01 9xxxxxxxx', NULL, '2020-08-22 11:40:36', '2020-09-14 10:13:57', 'Contact'),
(32, 'HLgyaQ', 'Email', 'support@yourdomain.com', NULL, '2020-08-22 11:41:14', '2024-03-07 15:36:38', 'Contact'),
...
(38, '9HOR1z', 'Security at it\'s core', 'E-PandaPay uses the highest levels of Internet Security to ensure that your information and funds are completely protected from fraud & hackers.', NULL, '2021-10-27 09:56:13', '2024-08-08 15:26:20', 'Home'),
(39, '7DH2G9', 'Two Factor Auth', 'Two-factor authentication (2FA) by default on all E-PandaPay accounts, to securely protect you from unauthorised access and impersonation.', NULL, '2021-10-27 09:56:26', '2021-10-27 09:56:26', 'Home'),
...
(41, 'Vg6Gy7', 'Powerful Trading Platforms', 'E-PandaPay offers multiple platform options to cover the needs of each type of trader and investors .', NULL, '2021-10-27 09:56:53', '2021-10-27 09:56:53', 'Home'),
...
(59, '39043d', 'Auth Aside Background Image', 'Auth Aside (Left) Background Image', '#bbcad3', '2024-03-07 16:02:12', '2024-03-07 15:37:39', 'Auth');
...
(1, 'Bitcoin', 10.00, 300.00, 0.00, 'Percentage', 'Instant', 'both', NULL, NULL, NULL, NULL, NULL, 'nbndb77hdu7yd', 'BTC', NULL, '', 'crypto', 'active', 1, '2024-01-10 20:41:10', '2024-03-22 23:57:34', NULL),
(2, 'Ethereum', 20.00, 1000.00, 1.00, 'percentage', NULL, 'both', 'https://s2.coinmarketcap.com/static/img/coins/200x200/1027.png', 'Firstbank', 'Livesmart Acount', '77656465', '324', 'sllskslss', 'ETH', NULL, 'BEP20', 'crypto', 'active', 1, '2024-02-20 16:39:23', '2024-03-22 23:57:49', 'Payment may take up to 2 Hours'),
(3, 'Litecoin', 100.00, 3000.00, 2.00, 'fixed', NULL, 'both', 'https://s2.coinmarketcap.com/static/img/coins/200x200/1027.png', NULL, NULL, NULL, NULL, 'jhd7dhd7d', 'LTC', 'barcodes/DOyk4iTGT79y73CxRwsYGCP91GuhkLU316YfdPY3.png', 'BEP20', 'crypto', 'active', 1, '2024-02-20 16:44:07', '2024-03-22 23:57:55', NULL),
(4, 'Bank Transfer', 100.00, 4500.00, 2.00, 'percentage', NULL, 'both', 'https://cdn-icons-png.flaticon.com/512/8043/8043680.png', 'Chvbank', 'Livesmart Acount', '65787878', '3242332', NULL, NULL, NULL, NULL, 'currency', 'active', 1, '2024-02-20 16:47:56', '2024-03-22 23:57:55', 'Payment may take up to 2 Hours'),
...
CREATE TABLE `settings` (
  ...
  `software_version` varchar(5) NOT NULL DEFAULT 6.1,
...
(1, 'E-PandaPay', 'E-PandaPay', 'Welcome to E-PandaPay', 'https://onlinetrnew.test', '/admin', 'settings/88H9WNBoRXRhNY65GjBLGFZfzwUy1pEIUw7H1Bza.png', 'settings/hksELWkej0sLiGAsVNreGCriSD3u3vLeGPkY1DQi.png', 'support@yourdomain.com', 'me@gmail.com', ' $', 'USD ', NULL, NULL, 'sk_test_51JP8qpSBWKZBQRLPWqHkFM8oqFEAqXLAaH3S8byZF73X0UycxijVyfebcyu6OVoZ8eeAelr3js3ADYIGU22Dk2Vo00kGkdE9xP', 'pk_test_51JP8qpSBWKZBQRLPUIfQVYfUGly65fb1LiPUwAUajKy1nVM9Rvly3v3hQLvXnRqrWCrnUNz1qPQHNSxE689tSAoL00B1iOTNfd', '-', '-', NULL, NULL, 1, 0, 1, 'Africa/Lagos', 'sendmail', 'onlintrade@happ.com', 'E-PandaPay', 'smtp.mailtrap.io', '2525', 'tls', '', '', '-', '-', 'https://E-PandaPay.test/auth/google/callback', '10', '5', '3.2', '2.34', '1', '0.51', 0.00, 0.00, '', 1, 0, 0, 1, 0, 'manual', 'manual', 'Coinpayment', 1, 'Coinpayment', 0, NULL, 1, 0, NULL, NULL, 1, 0, NULL, NULL, NULL, 30.00, 40.00, 50.00, '{\"signal\":\"false\",\"cryptoswap\":\"true\",\"investment\":\"true\",\"membership\":\"false\",\"subscription\":\"false\"}', 1, 0, 'Main-Domain', 1, 1, 1, 1, 1, 0, 1, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1, 1, 6.00, 0, '', '#2a5183', 'Deposit', 'millage', 'https://dudi.dev/optimize-laravel-database-queries/', '[\"purpose\", \"millage\"]', 'Stripe', 'userRequest', 'Welcome to E-PandaPay', '', '', '-', '-', 'https://api.paystack.co', 'mail@gmail.com', 1, NULL, NULL, 5.00, 1, 5.00, '', '6', 0.00, '-', '-', '-', '-', '-', '', '-', '-', '-', '-', 'mail@m', '{\"letters\": \"0\", \"numbers\": \"0\", \"symbols\": \"0\", \"leastChar\": \"8\", \"mixedCase\": \"0\", \"uncompromised\": \"0\"}', 0, '#ffffff', 1, 0.00, 1, 'https://www.instagram.com/', '-', '2018-03-22', 'https://twitter.com/', 'https://web.facebook.com/', 'home2', 0, '', 139, 140, 170, 160, 2, '2024-01-28 22:10:47', '2024-08-27 22:19:26');
...
(1, NULL, 'Driver', 'Jenny cole', 'I love this platform, its a good one and a media liver that movs the light forward ', 'media/sTnEPzjF31G5vcz3DYZYcCWj3Tu9hTm3kYQ4URFa.webp', '2024-02-21 22:23:11', '2024-02-22 13:45:15');
...
CREATE TABLE `users` (
  ...
  `account_bal` decimal(8,2) NOT NULL DEFAULT 0.00,
  `roi` decimal(8,2) NOT NULL DEFAULT 0.00,
  `bonus` decimal(8,2) NOT NULL DEFAULT 0.00,
  `ref_bonus` decimal(8,2) NOT NULL DEFAULT 0.00,
  `received_signup_bonus` tinyint(1) NOT NULL DEFAULT 0,
  `trade_mode` tinyint(1) DEFAULT 1,
  `reffered_by` varchar(255) DEFAULT NULL,
  `refferal_link` varchar(255) DEFAULT NULL,
  `account_verify` varchar(255) DEFAULT NULL,
  `status` varchar(255) NOT NULL DEFAULT 'active',
  `withdrawal_otp` varchar(255) DEFAULT NULL,
  `withdrawal_otp_expired_at` datetime DEFAULT NULL,
  `can_withdraw` tinyint(1) NOT NULL DEFAULT 1,
  `can_deposit` tinyint(1) NOT NULL DEFAULT 1,
  `email_preference` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`email_preference`)),
  ...
  `admin_two_factor_code` varchar(255) DEFAULT NULL,
  `pass_two_factor` tinyint(1) NOT NULL DEFAULT 1,
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `customer_status`, `assigned_to`, `date_of_birth`, `address`, `country`, `phone_number`, `bank_name`, `account_name`, `account_number`, `swift_code`, `btc_address`, `eth_address`, `ltc_address`, `usdt_address`, `account_bal`, `roi`, `bonus`, `ref_bonus`, `received_signup_bonus`, `trade_mode`, `reffered_by`, `refferal_link`, `account_verify`, `status`, `withdrawal_otp`, `withdrawal_otp_expired_at`, `can_withdraw`, `can_deposit`, `email_preference`, `remember_token`, `current_team_id`, `profile_photo_path`, `is_admin`, `admin_type`, `token_2fa_expiry`, `enable_2fa`, `admin_two_factor_code`, `pass_two_factor`, `timezone`, `created_at`, `updated_at`) VALUES
(2, 'Test User', 'testme1', 'test1234@happ.com', '2024-01-12 02:49:25', '$2y$12$Bjb2rHBL.P1gSinEKR8liOZ8CWNrdOS761zuEpKSd.P/DaMDoWgKS', NULL, NULL, NULL, 'Customer', NULL, NULL, NULL, 'Algeria', '002993344', NULL, NULL, NULL, NULL, 'hudyghd7dhgd7', NULL, NULL, NULL, 585.00, 18.00, 10.00, 0.00, 1, 1, NULL, 'https://E-PandaPaynew.test/ref/testme1', 'reject', 'active', NULL, NULL, 1, 1, NULL, NULL, NULL, 'avatars/QnaGKImtv4VTqL7pi8YULXJnv6uPXxA4svu9tV35.webp', 0, NULL, NULL, 0, NULL, 1, NULL, '2024-01-10 02:24:45', '2024-08-27 15:00:55'),
(3, 'Super Admin', 'admin', 'super@happ.com', '2024-01-12 02:49:25', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Algeria', '09839934433', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, 0.00, 0.00, 0.00, 0, 1, NULL, NULL, NULL, 'active', NULL, NULL, 1, 1, NULL, NULL, NULL, 'avatars/xwx2JR9tO8K0OcZDqk0tezfVJGkcqr57EiirgEc8.jpg', 1, '', NULL, 0, NULL, 1, NULL, '2024-01-10 02:27:12', '2024-08-26 20:04:27');
