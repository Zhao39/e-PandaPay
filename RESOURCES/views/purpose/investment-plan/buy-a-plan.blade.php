                ...
                <div class="card-body" x-data="{ open: false }">
                    <div class="form-group">
                        ...
                        <div class="border shadow-sm">
                            <div class="d-flex justify-content-between btn align-items-center rounded-0"
                                @click="open = ! open">
                                @if ($planSelected)
                                    <div>
                    ...
                    <div class="mt-4 form-group">
                        ...
                        <div>
                            <button class="mb-2 border border-black rounded-none btn btn-light btn-sm"
                    ...
                    <div class="mt-4 form-group">
                        ...
                        <div class="select-menu2">
                            <ul class="options2 d-block">
                                <li @class([
                                    'mb-3 option2',
                                    'bg-light border border-primary' => $paymentMethod == 'Account Balance',
                                ]) id="acnt">
                                    <i class="fas fa-wallet"></i>
                                    <span class="mr-2 option-text2 d-block">Account Balance </span> <br>
                                    <span class="small">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <span class="text-primary small font-weight-bold"
                                    style="font-size: 15px">{{ $planSelected ? $planSelected->name : '-' }}</span>
                            </div>
                            <div class="mb-3 col-md-6">
                                <p class="mb-0 small">Plan Price</p>
                                <span class="text-primary small font-weight-bold" style="font-size: 15px">
                                    {{ Number::currency($planSelected->price, $settings->s_currency) }}
                                </span>
                            </div>
                            <div class="mb-3 col-md-6">
