...
<div>
    <x-breadcrumbs title="Submit KYC" :homeUrl="route('user.dashboard')">
        <li class="nav-item">
            <a href="#">Submit KYC</a>
        </li>
    </x-breadcrumbs>
                                ...
                                <div class="row">
                                            ...
                                            <div class="selectgroup w-100">
                                                <label class="selectgroup-item">
                                                    <input type="radio" wire:model="document_type"
                                                        name="document_type" value="Int'l Passport"
                                                ...
                                                <label class="selectgroup-item">
                                                    <input type="radio" wire:model="document_type"
                                                        name="document_type" value="National ID"
                                                        class="selectgroup-input">
                                                    <span class="selectgroup-button">
                                                        National ID
                                                    </span>
                                                ...
                                                <label class="selectgroup-item">
                                                    <input type="radio" wire:model="document_type"
                                                        name="document_type" value="Drivers License"
                                                        class="selectgroup-input">
                                                    <span class="selectgroup-button">
                                                        Drivers License
                                                    </span>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="mt-3 align-items-center justify-content-around d-md-flex">
                                            <div>
                                                <x-form.input type="file" name="frontImg" required />
                                        ...
                                        <div class="mt-3 align-items-center justify-content-around d-md-flex">
                                            <div>
                                                <x-form.input type="file" name="backImg" required />
                                                <small>Size should not be greater than 30MB (images & PDF
                                                    allowed)</small>
                                            </div>
                                            <div class="text-center">
