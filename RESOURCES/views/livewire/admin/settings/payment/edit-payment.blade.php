<div class="col-lg-8 offset-lg-2">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.settings.payment.editMethod') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="form-row">
                    <div class="form-group col-lg-6">
                        <x-form.input name="id" type="hidden" value="{{ $id }}" />
                        <label>Method Name</label>
                        <x-form.input name="name" wire:model='name' required :readOnly="$default_pay" />
                        @if ($name == 'Credit-Debit Card')
                            <small class="">
                                Please ensure you have selected a credit card payment provider from
                                payment preference.
                            </small>
                        @endif
                    </div>
                    ...
                    @if ($methodtype === 'crypto')
                        ...
                        <div class="col-12 form-group">
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-6">
                                    <label>Symbol</label>
                                    <x-form.input name="coin" wire:model='coin' placeholder="BTC" :required="$methodtype === 'crypto'"
                                        :readOnly="$default_pay" />
                                </div>
                                <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-12">
                        <x-ui.button>
                            <x-spinner wire:loading wire:target="updateMethod" />
                            Save Method
                        </x-ui.button>
